...
describe('AuthenticateUser', function () {
    it('should be able to authenticate user.', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeUsersRepository, fakeHashProvider, authenticateUserService, createUserService, user, response;
    ...
    it('should be not able to authenticate with wrong email or pasword', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeUsersRepository, fakeHashProvider, authenticateUserService, createUserService;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fakeUsersRepository = new FakeUsersRepository_1.default();
