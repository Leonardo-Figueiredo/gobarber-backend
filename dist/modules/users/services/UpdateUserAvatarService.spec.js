...
var UpdateAvatarService_1 = __importDefault(require("./UpdateAvatarService"));
describe('UpdateUserAvatar', function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    updateUserAvatar = new UpdateAvatarService_1.default(fakeUsersRepository, fakeStorageProvider);
                    return [4 /*yield*/, fakeUsersRepository.create({
                            name: 'Jhon Doe',
                            email: 'jhondoe@123.com.br',
                            password: 'abc123abc',
                        })];
                case 1:
                    user = _a.sent();
    ...
    it('should not be able to update user avatar from non existing user.', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    it('should delet old avatar when updating new one.', function () { return __awaiter(void 0, void 0, void 0, function () {
