...
describe('CreateAppointment', function () {
    it('should be able to create a new appointment.', function () { return __awaiter(void 0, void 0, void 0, function () {
        var appointmentRepository, createAppointmentService, appointment;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    appointmentRepository = new FakeAppointmentsRepository_1.default();
                    createAppointmentService = new CreateAppointmentService_1.default(appointmentRepository);
    ...
    it('should not be able to create two appointments on the same time', function () { return __awaiter(void 0, void 0, void 0, function () {
        var appointmentRepository, createAppointmentService, appointmentDate;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    appointmentRepository = new FakeAppointmentsRepository_1.default();
                    createAppointmentService = new CreateAppointmentService_1.default(appointmentRepository);
                    appointmentDate = new Date(2020, 4, 1, 11);
                    return [4 /*yield*/, createAppointmentService.execute({
